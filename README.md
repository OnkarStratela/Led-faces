...
| `rainbow.py`        | Standalone fun script — green waves flow inward from both ends of the LED strip and meet at the centre. Independent of the RFID stack. Run with `sudo python3 rainbow.py`. |
